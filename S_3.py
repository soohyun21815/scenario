# S_3.py — MFA phishing / session hijack → mailbox/cloud → exfil
import json, os
...
SCENARIO_TECHNIQUES = [
    ...
    "Exfiltration of Data from Cloud Storage", # T1537
...
def main():
    ...
    print("\n[Scenario] MFA phishing / session hijack → mailbox/cloud → exfil")
